...
The rebuild is not uniformly plugin-oriented. Stages 1–5 extract Timer, Grouping, Entity References and Compact Document through owned Block, operation, annotation/panel/passive-effect and presentation capabilities. Legacy standoff effects, Cell CSS, region/projection paths and Block properties still use their specific central integrations. The [extension guides](../development/EXTENSION_ARCHITECTURE.md) document the available APIs and their limits; Stage 6 / History extraction is deferred.
