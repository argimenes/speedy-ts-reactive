...
function mountWorkspace() {
  const host = document.body.appendChild(document.createElement("div")); disposers.push(render(() => <WorkspaceDemo configuration={{ features: { codexSystemBar: false, publicHostedVersion: false } }} />, host)); return host;
}
