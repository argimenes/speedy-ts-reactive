...
import { isCell, type BlockEntry, type Bundle, type Certificate, type Manifest, type Row } from "./materialize";
...
/** Serialized session use, like the existing worker reader. No production routing. */
